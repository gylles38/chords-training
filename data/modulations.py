...
modulations = [
    ...
    },
    {
        ...
        "explanation_template": "Modulation de {start_key} vers son relatif mineur, {target_key}. L'accord {pivot_chord_name} (le V7 de {target_key}) sert à établir la nouvelle tonalité mineure."
    },
    {
